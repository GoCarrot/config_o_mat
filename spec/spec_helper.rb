...
require_relative 'fixtures/facter/default'
...
# with RSpec, but feel free to customize to your heart's content.
  ...
  config.example_status_persistence_file_path = "spec/rspec_persistence.txt"
  ...
  config.include_context 'with a logger', logger: true

  config.before do
    allow(Facter).to receive(:to_hash).and_return(
      Marshal.load(Marshal.dump(Fixtures::Facter::DEFAULT))
    )
  end
end
